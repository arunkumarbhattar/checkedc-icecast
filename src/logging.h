...
#define ICECAST_LOG_ERROR(...) ({ _Unchecked { log_write(errorlog, 1, CATMODULE "/", __func__, __VA_ARGS__); }})
#define ICECAST_LOG_WARN(...) ({_Unchecked { log_write(errorlog, 2, CATMODULE "/", __func__, __VA_ARGS__); }})
#define ICECAST_LOG_INFO(...) ({ _Unchecked { log_write(errorlog, 3, CATMODULE "/", __func__, __VA_ARGS__); }})
#define ICECAST_LOG_DEBUG(...) ({_Unchecked { log_write(errorlog, 4, CATMODULE "/", __func__, __VA_ARGS__); }})
